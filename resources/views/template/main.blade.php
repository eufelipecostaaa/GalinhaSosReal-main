...
<link href="https://fonts.googleapis.com/css2?family=Skranji&display=swap" rel="stylesheet">
    <style> 
        ...
        .navbar {
            background-color: #D2691E !important; /* Cor da barra de navegação */
        }
        .navbar-dark .navbar-toggler-icon {
            background-color: #fff; /* Cor do ícone do menu hambúrguer */
        }
        .text{
            color: #5f2f0c
        }
        /* Adicione a classe bg-custom aos elementos que deseja com a cor de fundo personalizada */
...
<nav class="navbar fixed-bottom navbar-dark bg-success">
    <div class="container-fluid">
        <span class="text-white fw-light"><b>Projeto feito por:</b> <a class="link-warning link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" href="https://www.instagram.com/eufelipecostaaa/?igshid=MmIzYWVlNDQ5Yg%3D%3D">Felipe Cardozo Costa</a> & <a class="link-warning link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" href="https://www.instagram.com/mirelacostacunha/">Mirela Da Costa Cunha</a></span>
    </div>
</nav>
