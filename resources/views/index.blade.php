...
<div class="row mb-5">
    <div class="banner">
        <img src="{{asset('img/bannerOvo1.webp')}}" width="100%" height="500px">
    </div>
    
    <div class="container d-flex justify-content-envely mt-5">
        <div class="img-galinha"><img src="{{asset('img/fotoGalinha.avif')}}" width="90%" height="90%" ></div>
        <div class="text-galinha column"><span>Galinhas</span><p>popopopopopopopopopopopopopopopopo</p></div>
    </div>
    <div class="col">
