...
<form action="{{ route('atividade.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col">
            <div class="form-floating mb-3">
                <textarea type="text" class="form-control @if($errors->has('biografia')) is-invalid @endif" name="descricao" placeholder="Descricao" style="min-height: 100px">{{old('descricao')}}</textarea>
    ...
    <div class="row">
        <div class="col">
            <div class="form-floating mb-3">
                <input type="date" class="form-control @if($errors->has('data')) is-invalid @endif" name="data" placeholder="Data" style="min-height: 100px">{{old('data')}}</input>
